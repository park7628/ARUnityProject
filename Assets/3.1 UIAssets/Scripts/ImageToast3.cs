...
public class ImageToast3 : MonoBehaviour
{
    private Image img;
    private float fadeInOutTime = 0.3f;
    private static ImageToast3 instance3 = null;

    public static ImageToast3 Instrance3
    {
        get
        {
            if (null == instance3) instance3 = FindObjectOfType<ImageToast3>();
            return instance3;
        }
    }
    ...
    public void showImage3(float durationTime)
    {
