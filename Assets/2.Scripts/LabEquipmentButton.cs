...
public class LabEquipmentButton : MonoBehaviour
{
    ...
    public void OnClickFunnel()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(Funnel, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
    ...
    public void OnClickGlasstube()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(glass_tube, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickIronring()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(ironring, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickPinchall()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(pinch_all, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    {   
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(retortstand, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickRtube()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(rtube, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickTube1()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(tube1, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickTube2()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(tube2, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickVial()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(Vial, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickWatertank()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(WaterTank, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
    ...
    public void OnClickYflask()
    {
        ...
        if (hits.Count > 0)
        {
            ...
            Instantiate(Y_Flask, SpawnPoint.transform.position, SpawnPoint.transform.rotation);
        }
    }
}
